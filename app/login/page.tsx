    ...
    <div className="min-h-screen flex flex-col items-center justify-center font-body text-[#1d1d1f] w-full">
      ...
      <main className="w-full max-w-md px-6 py-20 flex flex-col items-center text-center z-10 relative">
        ...
        <div className="apple-card w-full p-8 space-y-6">
          {/* Third Party Auth */}
          <button className="w-full flex items-center justify-center gap-3 bg-white border border-[#d2d2d7] py-3.5 px-6 rounded-2xl hover:bg-[#f5f5f7] transition-all active:scale-[0.98]">
          ...
          <div className="flex items-center gap-4 py-2">
            ...
            <span className="text-xs font-semibold text-gray-600 uppercase tracking-wider">or</span>
            <div className="h-[1px] flex-1 bg-[#e5e5ea]"></div>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <button 
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#1d1d1f] z-10 pointer-events-auto flex items-center justify-center"
                >
