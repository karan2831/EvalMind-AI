...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-body text-[#1d1d1f] w-full">
      ...
      {/* Main Content Canvas */}
      <main className="w-full max-w-md px-4 sm:px-6 py-20 flex flex-col items-center text-center z-10 relative">
        <div className="mb-10">
        ...
        <div className="apple-card w-full p-8 space-y-6">
          ...
          >
            ...
            <span className="font-semibold text-gray-900">{googleLoading ? 'Connecting...' : 'Continue with Google'}</span>
          </button>
